...
namespace UnitTestTutorial.Api
{
    ...
    public static class DependencyInjection
    {
        ...
        public static IApplicationBuilder UseAppSwagger(this IApplicationBuilder app, IConfiguration configuration)
        {
            ...
            {
                options.SwaggerEndpoint("/swagger/v1/swagger.json", "UnitTestTutorial.WebUI v1");
                options.SwaggerEndpoint("/swagger/v2/swagger.json", "UnitTestTutorial.WebUI v2");
